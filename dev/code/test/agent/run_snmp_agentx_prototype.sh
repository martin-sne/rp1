...
echo ""
echo "    cd `pwd`"
echo "    snmpwalk -v 2c -c public -M+. localhost:5555 ARPA2-Experimental-DNSSEC-MIBv1::arpa2experimentaldnssecMIBv1"
echo "    snmpget -v 2c -c public -M+. localhost:5555 ARPA2-Experimental-DNSSEC-MIBv1::dnssecZoneCount.0"
echo "    snmptable -v 2c -c public -M+. -Ci localhost:5555 ARPA2-Experimental-DNSSEC-MIBv1::dnssecGlobalTable"
echo ""
